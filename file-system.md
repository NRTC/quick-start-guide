...
‫    ext : نسخه قدیمی تر فایل سیستم دیگری به نام ext2 است که از نسخه های جدیدتر این فایل سیستن پشتیبانی نمی کرد ، به ندرت از این فایل سیستم در سیستم عامل های جدید استفاده می شود و معمولا با ext2 جایگزین می شود.
...
‫    hpfs : این نوع فایل سیستم همانطور که از نامش هم پیداست High Performance File System است و در سیستم عام OS//2 استفاده می شود.

...
-log 
---
‫در هر نقطه ای از git که باشیم می‌توانیم تاریخچه‌ی commit هارا بررسی کنیم. این تاریخچه اطلاعاتی درباره اسم شخص (author) ایجاد کننده commit، تاریخ ایجاد و یاتغییر فایل و علت تغییر یا ایجاد فایل به ما می‌دهد.‬
```
$ git log
```
‫می‌توان با اضافه کردن پارامترهایی به دستور فوق نسخه فشرده کامیت‌ها را در یک خط ببینیم، یا آن‌ها را به صورت شاخه‌ای ببینیم.‬
